...
useEffect(()=>{
  ...
  let getData=async()=>{
      let res= await axios.get(`${env.REACT_APP_API_URL}commercial`)
   ...
   return (
    <>
   <div className='head'>
   <h1 className='head1'>^^^ Commercial ^^^</h1> 
   <h1 className='head2'>commercial</h1>
   </div>
    ...
    <div class="container-fluid bg-trasparent my-2 p-3 "  >
        ...
        <div class="row row-cols-1 row-cols-xs-2 row-cols-sm-2 row-cols-lg-4 g-3">
        {
            ...
            <div class="col midss" >
                ...
                <div class="card h-100 shadow-sm"> <img className='images' src={`${env.REACT_APP_API_URL}${e.avatar}`}/>
                    <div class="card-body">
